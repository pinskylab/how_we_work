...
1. Each new project gets a GitHub repository in the [pinskylab organization](https://github.com/pinskylab)
   ...
   1. A README.md in each directory (including the top directory) 
      ...
      1. describes all data files in the directory and includes links to any data files not in the repo along with instructions for how to download and set them up in the repo so that scrips can run
      1. includes links to relevant papers and preprints (top level only)
      1. has contact information for authors and data creators, as necessary (top level only)
